...
const FIELD_ALIASES = {
  YOUZAN_ORDER: {
    ...
    productName: ["productName", "product_name", "商品名称", "商品名"],
    productId: ["productId", "product_id", "商品ID", "商品id", "商品编码"],
    amount: ["amount", "实付金额", "支付金额", "订单金额"],
    paidAt: ["paidAt", "paid_at", "支付时间", "付款时间"],
    orderStatus: ["orderStatus", "order_status", "订单状态", "支付状态"],
    deliveryStatus: ["deliveryStatus", "delivery_status", "物流状态", "配送状态"],
    rawAddressText: ["rawAddressText", "raw_address_text", "地址", "收货地址", "原始地址文本"],
  },
  FULFILLMENT: {
